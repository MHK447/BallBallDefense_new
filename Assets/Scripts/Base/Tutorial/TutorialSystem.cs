...
public class TutorialSystem
{
    ...
    public GameObject GetTarget(TutorialIdent id, int targetIdx = -1, int targetSubIdx = -1)
    {
        switch (id)
        {
            // case TutorialIdent.GetWeaponBall:
            //    {
            //         //return GameRoot.Instance.InGameSystem.GetInGame<InGameBase>().Stage.PlayerUnitGroup.gameObject;
            //    }
